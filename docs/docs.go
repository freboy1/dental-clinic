...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/clinics/{clinicId}/clinic-addresses/{addressId}/inventory-status": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "number",
                        "description": "Yellow threshold. Default is 5",
                        "name": "threshold",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.InventoryStatusResponse"
                            }
                        }
                    },
                    "400": {
